...
local portugueseTranslations = {
    ...
    ["Scared Kitty"] = "Gatinho Assustado",
    ["Vendor"] = "Vendedor",
    ["Now find the maze exit and bring all"] = "Agora encontre a saída do labirinto e leve todos os",
    ["cats to safety!"] = "gatos em segurança!",
    ["TROLL everyone!"] = "TROLE todo mundo!",
    ["IS TROLLING EVERYONE!"] = "ESTÁ TROLANDO TODO MUNDO!",
    ["Kitties rescued:"] = "Gatinhos resgatados:",
    ["Controls:"] = "Controles:",
    ["Move"] = "Mover",
    ["L-STICK"] = "L-STICK",
    ["Look"] = "Olhar",
